...
const PRODUCTS = [
  ...
  {
    id: "lampe-soleil", used: true, grade: "wieneu", year: "2021", name: "Soleil", categoryKey: "leuchten", shape: "lampe", tone: "sand",
    price: 1290, weight: "9 kg", swatches: ["#e5d3ab", "#ece7dc", "#a6663f"],
    t: {
      de: { short: "Stehleuchte mit handgefaltetem Schirm aus Pergamentpapier.",
        description: "Der Schirm der Soleil wurde von Hand aus Pergamentpapier gefaltet und über ein Gestell aus Messingdraht gespannt. Diese Leuchte stand in einem Showroom in Lyon und ist ohne Gebrauchsspuren; Fassung und Kabel haben wir erneuert. Das Licht fällt weich und warm — ideal als Grundbeleuchtung neben dem Sofa. Dimmbar über einen Fußschalter.",
      ...
      en: { short: "Floor lamp with a hand-folded parchment shade.",
        description: "The Soleil shade was folded by hand from parchment paper and stretched over a brass wire frame. This lamp stood in a Lyon showroom and carries no signs of use; socket and cable have been renewed. The light falls soft and warm — ideal as ambient light beside the sofa. Dimmable with a foot switch.",
      ...
      fr: { short: "Lampadaire à abat-jour en parchemin plié à la main.",
        description: "L'abat-jour du Soleil a été plié à la main dans du papier parchemin et tendu sur une armature en fil de laiton. Cette lampe se trouvait dans un showroom lyonnais et ne présente aucune trace d'usage ; la douille et le câble ont été remplacés. La lumière est douce et chaude — idéale comme éclairage d'ambiance près du canapé. Variateur au pied.",
      ...
      es: { short: "Lámpara de pie con pantalla de pergamino plegada a mano.",
        description: "La pantalla del Soleil se plegó a mano en papel pergamino y se tensó sobre una armadura de alambre de latón. Esta lámpara estuvo en un showroom de Lyon y no presenta señales de uso; casquillo y cable se han renovado. La luz cae suave y cálida — ideal como luz ambiente junto al sofá. Regulable con interruptor de pie.",
  ...
  {
    id: "leuchte-alba", used: true, grade: "wieneu", year: "2022", name: "Alba", categoryKey: "leuchten", shape: "haengeleuchte", tone: "studio",
    price: 15000, weight: "34 kg", swatches: ["#c8b48a", "#e7e2d8", "#7d6a4e"],
    t: {
      de: { short: "Hängeleuchte mit fünf mundgeblasenen Glaskörpern an einem Träger aus massivem Messing.",
        description: "Alba wurde als Sonderanfertigung für ein Privathaus am Gardasee gebaut und kommt aus diesem abgeschlossenen Projekt zu uns. Fünf Glaskörper wurden in Murano einzeln mundgeblasen — keiner gleicht dem anderen. Sie hängen an einem Träger aus massivem Messing. Die Höhe jedes einzelnen Glases lässt sich beim Aufbau neu bestimmen, sodass die Leuchte auch in Ihrem Raum einer Tafel, einer Treppe oder einem Luftraum folgt. Glas und Messing sind ohne Fehlstellen, die Elektrik ist geprüft und auf LED umgerüstet.",
        material: "Mundgeblasenes Muranoglas, massives Messing", dimensions: "B 180 × T 30 × H 90–260 cm (Abhängung verstellbar)",
        origin: "Glashütte Murano, Italien", lead: "16–20 Wochen", colors: ["Messing gebürstet", "Alabasterweiß", "Bronze dunkel"] },
      en: { short: "Pendant with five mouth-blown glass bodies on a solid brass carrier.",
        description: "Alba was built to measure for a private house on Lake Garda and comes to us from that completed project. Five glass bodies were individually mouth-blown in Murano — no two alike. They hang from a solid brass carrier. The height of each glass can be set again during installation, so the piece follows a table, a staircase or an atrium in your room too. Glass and brass are flawless; the wiring has been tested and converted to LED.",
        material: "Mouth-blown Murano glass, solid brass", dimensions: "W 180 × D 30 × H 90–260 cm (adjustable drop)",
        origin: "Murano glassworks, Italy", lead: "16–20 weeks", colors: ["Brushed brass", "Alabaster white", "Dark bronze"] },
      fr: { short: "Suspension à cinq corps de verre soufflés à la bouche sur un support en laiton massif.",
        description: "Alba a été réalisée sur mesure pour une maison privée au bord du lac de Garde et nous vient de ce projet achevé. Cinq corps de verre ont été soufflés à la bouche un à un à Murano — aucun n\u2019est identique. Ils sont suspendus à un support en laiton massif. La hauteur de chaque verre se règle à nouveau à la pose, afin que la suspension épouse une table, un escalier ou un vide chez vous aussi. Le verre et le laiton sont sans défaut ; l\u2019électricité a été contrôlée et convertie en LED.",
        material: "Verre de Murano soufflé à la bouche, laiton massif", dimensions: "L 180 × P 30 × H 90–260 cm (hauteur réglable)",
        origin: "Verrerie de Murano, Italie", lead: "16–20 semaines", colors: ["Laiton brossé", "Blanc albâtre", "Bronze foncé"] },
      es: { short: "Lámpara de suspensión con cinco cuerpos de vidrio soplados a boca sobre un soporte de latón macizo.",
        description: "Alba se realizó a medida para una casa privada junto al lago de Garda y nos llega de ese proyecto finalizado. Cinco cuerpos de vidrio se soplaron a boca uno a uno en Murano — no hay dos iguales. Cuelgan de un soporte de latón macizo. La altura de cada vidrio se vuelve a decidir durante el montaje, de modo que la lámpara siga también en su casa una mesa, una escalera o un espacio a doble altura. Vidrio y latón están sin defectos; la instalación eléctrica se ha revisado y convertido a LED.",
        material: "Vidrio de Murano soplado a boca, latón macizo", dimensions: "An 180 × Pr 30 × Al 90–260 cm (caída regulable)",
        origin: "Vidriería de Murano, Italia", lead: "16–20 semanas", colors: ["Latón cepillado", "Blanco alabastro", "Bronce oscuro"] }
    }
  },
  {
    id: "leuchte-vertice", used: true, grade: "sehrgut", year: "2019", name: "Vertice", categoryKey: "leuchten", shape: "lampe", tone: "studio",
    ...
    t: {
      de: { short: "Stehleuchte mit Schirm aus geschliffenem Alabaster auf einem Fuß aus Blaustein.",
        description: "Der Schirm der Vertice wurde aus einem einzigen Block Alabaster geschliffen und so weit ausgedünnt, dass das Licht durch den Stein hindurchtritt. Jede Maserung ist ein Unikat. Der Fuß aus belgischem Blaustein hält die Leuchte ohne Verankerung; das Vorschaltgerät ist im Schaft verborgen. Das Stück stammt aus einer Hotellobby in Antwerpen: der Blaustein zeigt an der Kante leichte Gebrauchsspuren, der Alabaster ist unversehrt.",
      ...
      en: { short: "Floor lamp with a ground alabaster shade on a bluestone base.",
        description: "The Vertice shade was ground from a single block of alabaster and thinned until the light passes through the stone. Every vein is unique. The Belgian bluestone base holds the lamp without fixing; the driver is concealed in the stem. The piece comes from a hotel lobby in Antwerp: the bluestone shows light wear along one edge, the alabaster is untouched.",
      ...
      fr: { short: "Lampadaire à abat-jour en albâtre taillé sur un socle en pierre bleue.",
        description: "L\u2019abat-jour du Vertice a été taillé dans un seul bloc d\u2019albâtre, aminci jusqu\u2019à ce que la lumière traverse la pierre. Chaque veine est unique. Le socle en pierre bleue de Belgique tient la lampe sans fixation ; l\u2019alimentation est dissimulée dans le fût. La pièce provient du hall d\u2019un hôtel d\u2019Anvers : la pierre bleue présente de légères traces sur une arête, l\u2019albâtre est intact.",
      ...
      es: { short: "Lámpara de pie con pantalla de alabastro tallado sobre base de piedra azul.",
        description: "La pantalla del Vertice se talló en un único bloque de alabastro y se adelgazó hasta que la luz atraviesa la piedra. Cada veta es única. La base de piedra azul belga sostiene la lámpara sin anclaje; el equipo va oculto en el fuste. La pieza procede del vestíbulo de un hotel de Amberes: la piedra azul muestra leves marcas en una arista, el alabastro está intacto.",
